...
public class admin_servlet extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res)throws ServletException, IOException 
	{
		...
		if(type.endsWith("adminMana")) //参数是否是adminMana字符串为结尾,返回TRUE，否则FALSE
		{
			adminMana(req, res);
		}
	...
	public void adminAdd(HttpServletRequest req,HttpServletResponse res)    //管理员添加
	{
	...
	public void adminDel(HttpServletRequest req,HttpServletResponse res)      //管理员删除
	{
